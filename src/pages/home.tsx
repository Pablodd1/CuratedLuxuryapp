  ...
  return (
    <Layout title="CuratedLux" active="scan">
      <div class="max-w-2xl mx-auto text-center py-16">
        ...
        <a href="/valuation"
          class="inline-flex items-center gap-2 bg-gold hover:bg-gold-light text-black font-semibold px-6 py-3 rounded text-sm transition-all shadow-[0_0_30px_rgba(138,28,44,0.15)] hover:shadow-[0_0_40px_rgba(138,28,44,0.25)]">
